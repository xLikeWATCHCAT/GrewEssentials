...
public class GrewEssentials extends JavaPlugin {
    ...
    public SimpleConfig<WarpConfig> data =new SimpleConfig(new File(this.getDataFolder(),"data"+File.separator+"warps.json").getAbsoluteFile().toString(),"UTF8",WarpConfig.class);
