...
public class GrewPluginManager {
    ...
    {
        //File f=ReflectionWrapper.getFieldValue(ReflectionWrapper.getField(JavaPlugin.class,"file"),p);
            ...
            if (loader != null) {
                ...
                try {
                    ...
                    if (((String)ReflectionWrapper.getFieldValue(ReflectionWrapper.getField(description.getClass(),"rawName"),description)).indexOf(32) != -1) {
                        Bukkit.getServer().getLogger().warning(String.format("GrewPluginManager `%s' uses the space-character (0x20) in its name `%s' - this is discouraged", description.getFullName(), ReflectionWrapper.getFieldValue(ReflectionWrapper.getField(description.getClass(),"rawName"),description)));
                    }
