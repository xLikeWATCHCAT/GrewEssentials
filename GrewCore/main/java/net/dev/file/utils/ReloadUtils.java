...
import static net.dev.manager.BukkitPluginManager.*;
...
public class ReloadUtils {
    ...
    public static void reloadData(){
        try {
            GrewEssentials.getInstance().warp.loadConfig();
            GrewEssentials.getInstance().teleportjoin.loadConfig();
            GrewEssentials.getInstance().home.loadConfig();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void reloadAll(boolean js){
        try{
        reloadBossBar();
        reloadConfig();
        reloadDatabase();
        ...
        if(js||GrewEssentials.getInstance().Message.getBoolean("Reload.ReloadPlugin",false)){
            try {
